...
- (void)viewDidLoad {
    ...
    NSString *path2 = @"file:///Users/zhaohaifang/Desktop/untitled.html";
    NSString *path3 = @"http://mp.weixin.qq.com/s/SUHqbbYa-EQj0Ns-dVG4Yg";
    NSString *path4 = @"https://www.baidu.com";
...
- (void)updateContainerScrollViewContentSize:(NSInteger)flag webViewContentHeight:(CGFloat)inWebViewContentHeight{
    ...
    NSLog(@"%f%f",webViewContentHeight,tableViewContentHeight);
...
//
//        //取得高度
//        CGFloat webHeight = [result doubleValue];
//        NSLog(@"*******%f",webHeight);
//    }];
//}
